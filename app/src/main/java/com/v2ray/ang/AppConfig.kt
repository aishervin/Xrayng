...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/aishervin/xrayng"
    const val APP_API_URL = "https://api.github.com/repos/aishervin/xrayng/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/aishervin/xrayng/master/CR.md"
    const val APP_PROMOTION_URL = "aHR0cHM6Ly85LjIzNDQ1Ni54eXovYWJjLmh0bWw="
    const val TG_CHANNEL_URL = "https://t.me/shervini"
    ...
    const val MSG_MEASURE_GEMINI_START = 75
    const val MSG_MEASURE_GEMINI_SUCCESS = 76
    ...
    const val TG_SOCKS = "tg://socks"
    const val TG_HTTP = "tg://http"
